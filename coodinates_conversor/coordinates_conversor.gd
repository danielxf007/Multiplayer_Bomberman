...
func get_cell_coordinates_on_board(cell_pos: Vector2) -> Tuple:
	return Tuple.new(ceil(cell_pos.y/self.cell_dim.second_element) -1,
	ceil(cell_pos.x/self.cell_dim.first_element) -1)
